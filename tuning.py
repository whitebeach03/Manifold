...
def main():
    ...
    for i in N:
        ...
        if data_type == 'mnist':
            ...
            train_loader, val_loader = create_loaders(train_dataset, split_path=f'data_split_indices_cifar_{N_train}.pkl', batch_size=batch_size, save_if_missing=False)
        elif data_type == 'stl10':
            batch_size    = 64
        ...
        with open(f'./history/{model_type}/Fine-Tuning/{augment}/{data_type}_{epochs}_{N_train}.pickle', 'wb') as f:
        ...
        with open(f'./history/{model_type}/Fine-Tuning/{augment}/{data_type}_{epochs}_{N_train}_test.pickle', 'wb') as f:
