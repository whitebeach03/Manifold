...
def main():
    ...
    parser.add_argument('--red', default='lle',   choices=['kpca', 'lle', 'umap'])
    ...
    if red == 'kpca':
        ...
        reduced_data, umap_model = umap_reduction(data, n_components=2, n_neighbors=15, min_dist=0.1, random_state=42)
